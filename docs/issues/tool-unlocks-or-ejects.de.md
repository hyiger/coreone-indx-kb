...
superseded_by:
source_sha:   58bf60696bec2c91e2f8faa7d1c5e0bbcf55abd4ac535240280b7333dd848425
---
# Werkzeug entriegelt sich oder fällt aus dem Kopf

!!! warning "Zwei Besitzer, ein Thread und eine Demontage"
    ...
    wie verbreitet der Defekt ist. `provisional`.
...
Nachdem sich das Werkzeug gelöst hatte, fand der erste Besitzer den Drucker in einer
Schleife aus Andockversuchen, mit nur Retry und Abort zur Wahl. Nach einem Neustart
meldete er ein vorhandenes Werkzeug, ohne zu wissen welches, und versuchte sofort
wieder, es anzudocken — womit der Menüpunkt „Release Stuck Tool“, der es hätte lösen
können, unerreichbar blieb.
...
Anleitung zum Zerlegen des Werkzeugkopfs oder ein Ersatz-Werkzeugkopf.
...
`provisional` — zwei Besitzer in einem Thread und eine physische Ursache, gefunden an nur
einer Maschine.
...
Der Beitrag mit der Demontage wartete noch auf Freigabe im Forum, als diese Seite
geschrieben wurde; der Link zeigt ihn daher womöglich noch nicht jedem Leser. Das Video
